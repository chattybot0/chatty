...
var token = "NzQyMzg1Nzg4MTM4MDI5MDg2.XzFWpA.LmpXQlVlyHP6HwKqkKB1M2GHJ8o";
var clid = "742385788138029086";
var name = "Charley";
var themes = [
  "Kingdom of fun",
  "The wonder empire",
  ...
  "Empire of the Fun",
  "Fun Love island",
  "The Dothrakis kingdom",
  "The Palace of Ghosts",
  "Adventure land Bazaar",
  "Kids in wonderland",
  "The big festival",
  "The Fun Island",
  "Fun Gallery",
...
var dares = [
  ...
  "Act like your class teacher.",
  "Go out and hug the tree.",
  "Say the alphabet, backwards.",
  "Clap your hand backward.",
  "Try to act like a bird.",
  "Dig a hole in your yard with one hand.",
  "Run with both your hands tied up.",
  "Walk with both legs tied up.",
  ...
  "Enact a story without saying a word.",
  "Dance on a sheet of A4 paper.",
  "Hymn a song without singing.",
  ...
  "Ask someone to prank you.",
  "Taste your bath soap.",
  "Do as many pushups you can.",
  "Drink a cup of tea/coffee like a dog.",
  "Go outside and do belly dance.",
  "Peel banana using your toes.",
  "Do cartwheel by holding your mobile.",
  "Let someone wax half of your leg.",
  "Reveal your deepest secret.",
  "Taste the ink of any pen in front of you.",
  "Wear your opposite gender's clothes.",
  "Do manicure to your best friend.",
  "Let someone tickle you for 20 seconds.",
  "Eat two boiled eggs at a time.",
  "Bite someone's hand.",
  "Bite someone's lefthand fingernails.",
  "Spit as far as you can.",
  "Call your crush and flirt him/her.",
  "Put your finger on someone's ear.",
  "Sit on your hands for one minute.",
  "Shave underarms immediately.",
  "Eat a mouthful of unboiled noodles.",
  "Imitate your friend crush's voice"
];
var truths = [
...
client.on("ready", () => {
  //SET ACTIVITY
  client.user.setActivity("-truth -dare -theme");
});
client.on("message", msg => {
  
  if (msg.content == "-truth") {
    msg.reply(truths[between(0,truths.length - 1)]);
  } else if (msg.content == "-dare") {
    msg.reply(dares[between(0,truths.length - 1)]);
  } else if (msg.content == "-theme") {
    msg.reply(themes[between(0, themes.length - 1)]);
  }
});